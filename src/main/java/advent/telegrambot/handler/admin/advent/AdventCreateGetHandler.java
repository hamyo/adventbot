...
public class AdventCreateGetHandler implements MessageHandler {
    ...
    public void handle(Update update) {
        ...
        SendMessage response = SendMessage.builder()
                ...
                .text("""
                        Для создания нового адвента укажите:
                        дату начала,
                        тип ежедневного старта: 1 (нужно любое сообщение от любого участника), 2 (нужно прислать один из кодов, коды создаются автоматически при создании шага или можно создать заранее на нужное количество дней)
